...
const ACC = {
  ...
  DRAWINGS: '3300', // مسحوبات شخصية
  SALES: '4100', // إيرادات المبيعات
  SALES_RETURNS: '4200', // مردودات مبيعات
...
const CHART_OF_ACCOUNTS = [
  ...
  { code: ACC.CAPITAL, name: 'رأس المال', type: 'equity', parent_code: '3000', is_postable: 1 },
  { code: ACC.OPENING_EQUITY, name: 'أرصدة افتتاحية وأرباح مرحلة', type: 'equity', parent_code: '3000', is_postable: 1 },
  { code: ACC.DRAWINGS, name: 'مسحوبات شخصية', type: 'equity', parent_code: '3000', is_postable: 1 },
