...
(function (root, factory) {
  ...
  const DEFAULT_ACCOUNTS = [
    ...
    ['5104', 'تكلفة النقل البري', '51'], ['5105', 'تكاليف تشغيل ومزارات', '51'], ['5106', 'تكاليف السياحة الداخلية (فنادق وقرى)', '51'], ['5107', 'تكاليف رحلات اختيارية وإضافات', '51'], ['5108', 'تكلفة الحج', '51'],
